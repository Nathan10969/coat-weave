...
def main() -> int:
    ...
    parser.add_argument(
        ...
        action="append",
        default=None,
        help="Restrict patent/evidence/fact export to a document id. Can be repeated.",
    )
    args = parser.parse_args()

    summary = build_kg_export(args.project_root, out_dir=args.out_dir, doc_ids=args.doc_id)
