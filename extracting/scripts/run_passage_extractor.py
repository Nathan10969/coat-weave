"""Batch driver for stage 9.5 — passage_extractor (L1 Retrieval Context).
...
Output: data/layer1/<doc_id>/layer1.json (one file per PDF).
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Stage 9.5 batch — L1 Retrieval Context extraction")
    ...
    print(f"  Output dir:  {REPO / 'data' / 'layer1'}")
    ...
    print(f"  total figures (L1 Retrieval Context): {n_total_figures}")
